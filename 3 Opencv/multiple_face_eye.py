...
face_cascade = cv2.CascadeClassifier(r"C:\AVSCODE\Opencv\harscascade\haarcascade_frontalface_default.xml")
eye_cascade = cv2.CascadeClassifier(r"C:\AVSCODE\Opencv\harscascade\haarcascade_eye.xml")
