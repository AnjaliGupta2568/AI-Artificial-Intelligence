...
face_classifier = cv2.CascadeClassifier(r"C:\AVSCODE\Opencv\harscascade\haarcascade_frontalface_default.xml")
eye_classifier = cv2.CascadeClassifier(r"C:\AVSCODE\Opencv\harscascade\haarcascade_eye.xml")

# Load the image

img = cv2.imread(r"C:\AVSCODE\Opencv\men.jpg")
